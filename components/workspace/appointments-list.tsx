        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href="/doctors">
            <Button
              variant="outline"
              size="sm"
              className="gap-1.5 text-xs text-teal-800 bg-teal-50/60 border-teal-200 hover:bg-teal-100/70 h-8 px-3 shadow-2xs font-semibold w-full sm:w-auto"
            >
              ...
              return (
                <div
                  ...
                  className={`group flex flex-col justify-between gap-3 rounded-xl border p-4 transition-all sm:flex-row sm:items-center ${
                    isMissed
                      ? "border-rose-200 bg-gradient-to-r from-rose-50/70 via-white to-white hover:border-rose-300"
