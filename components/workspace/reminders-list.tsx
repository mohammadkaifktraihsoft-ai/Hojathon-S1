  ...
  return (
    <UICard className="border-slate-200/90 shadow-xs overflow-hidden">
      ...
      <UICardContent className="p-4 sm:p-6">
        <div className="mb-4 flex items-start gap-2.5 rounded-xl bg-slate-50 p-3 text-xs text-slate-600 border border-slate-200/60">
          ...
          <div className="space-y-3">
            {reminders.map((reminder) => {
              ...
              return (
                <div
                  key={reminder.id}
                  className="flex flex-col justify-between gap-2.5 rounded-xl border border-slate-200 bg-white p-4 transition-all hover:border-teal-300 hover:shadow-xs sm:flex-row sm:items-center"
                >
